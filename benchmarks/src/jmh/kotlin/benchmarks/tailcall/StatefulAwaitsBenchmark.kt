...
// ./gradlew --no-daemon cleanJmhJar jmh -Pjmh="StatefulAsyncBenchmark"
/*
...
//    }
    ...
    @Benchmark
    fun dependentStateAsync() = kotlinx.coroutines.runBlocking {
        val broadcastChannel = kotlinx.coroutines.channels.BroadcastChannel<Int>(1)
        val subscriptionChannel = kotlinx.coroutines.channels.Channel<Int>(jobsCount)
    ...
    private fun launchJob(
        stateNum: Int,
        channel: kotlinx.coroutines.channels.BroadcastChannel<Int>,
        subscriptionChannel: kotlinx.coroutines.channels.Channel<Int>
