...
import coroutines.internal.ArrayQueue
import coroutines.internal.DispatchedTask
import coroutines.internal.LockFreeTaskQueueCore
import coroutines.internal.Symbol
...
internal object ThreadLocalEventLoop {
    private val ref = ThreadLocal<EventLoop?>()
...
internal fun createEventLoop(): EventLoop = BlockingEventLoop(Thread.currentThread())
